...
task.set_base_docker("nvidia/cuda:11.4.0-cudnn8-devel-ubuntu20.04", docker_setup_bash_script=["git clone https://github.com/pytorch/fairseq", "cd fairseq", "pip install ./"])
